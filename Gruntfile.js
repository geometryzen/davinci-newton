module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            ...
            amd: {
                src: 'dist/davinci-newton.js',
                dest: 'dist/davinci-newton.min.js'
            },
            system: {
                src: 'dist/davinci-newton-system-es5.js',
                dest: 'dist/davinci-newton-system-es5.min.js'
            }
        },
    ...
    function bundle() {
        ...
        return builder.bundle('davinci-newton.js', 'dist/davinci-newton-system-es5.js', options);
    }
