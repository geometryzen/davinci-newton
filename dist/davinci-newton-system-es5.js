...
System.register("davinci-newton/graph/DisplayAxes.js", ["../view/DoubleRect", "../view/HorizAlign", "../checks/isDefined", "../view/VerticalAlign"], function (exports_1, context_1) {
    "use strict";

    var __moduleName = context_1 && context_1.id;
    var DoubleRect_1, HorizAlign_1, isDefined_1, VerticalAlign_1, DisplayAxes;
    return {
        setters: [function (DoubleRect_1_1) {
            DoubleRect_1 = DoubleRect_1_1;
...
System.register("davinci-newton/engine3D/RigidBodySim.js", ["../util/AbstractSubject", "../math/Bivector3", "../util/contains", "../model/EnergyInfo", "../util/remove", "../core/SimList", "../core/VarsList", "../math/Vector3"], function (exports_1, context_1) {
    ...
    var AbstractSubject_1, Bivector3_1, contains_1, EnergyInfo_1, remove_1, SimList_1, VarsList_1, Vector3_1, var_names, i18n_names, Offset, NUM_VARS_IN_STATE, RigidBodySim;
    return {
        setters: [function (AbstractSubject_1_1) {
            AbstractSubject_1 = AbstractSubject_1_1;
        }, function (Bivector3_1_1) {
...
System.register("davinci-newton/view/SimView.js", ["../util/AbstractSubject", "../util/clone", "../util/contains", "./CoordMap", "./DisplayList", "./DoubleRect", "../util/GenericEvent", "./HorizAlign", "../util/ParameterBoolean", "../util/ParameterNumber", "../util/remove", "./ScreenRect", "./VerticalAlign", "../util/veryDifferent"], function (exports_1, context_1) {
    ...
    var __moduleName = context_1 && context_1.id;
    var AbstractSubject_1, clone_1, contains_1, CoordMap_1, DisplayList_1, DoubleRect_1, GenericEvent_1, HorizAlign_1, ParameterBoolean_1, ParameterNumber_1, remove_1, ScreenRect_1, VerticalAlign_1, veryDifferent_1, SimView;
    return {
        setters: [function (AbstractSubject_1_1) {
            AbstractSubject_1 = AbstractSubject_1_1;
        }, function (clone_1_1) {
