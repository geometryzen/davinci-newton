...
describe("Dimensions", function () {
    describe("constructor", function () {
        it("properties match construction arguments", function () {
            var M = QQ_1.QQ.valueOf(2, 3);
            var L = QQ_1.QQ.valueOf(3, 5);
            var T = QQ_1.QQ.valueOf(5, 7);
            var Q = QQ_1.QQ.valueOf(7, 11);
            var temperature = QQ_1.QQ.valueOf(11, 13);
            var amount = QQ_1.QQ.valueOf(13, 17);
            var intensity = QQ_1.QQ.valueOf(17, 19);
            var x = Dimensions_1.Dimensions.valueOf(M, L, T, Q, temperature, amount, intensity);
    ...
    it("Construction(QQ)", function () {
        var M = QQ_1.QQ.valueOf(1, 1);
        var L = QQ_1.QQ.valueOf(2, 1);
        var T = QQ_1.QQ.valueOf(3, 1);
        var Q = QQ_1.QQ.valueOf(4, 1);
        var temperature = QQ_1.QQ.valueOf(5, 1);
        var amount = QQ_1.QQ.valueOf(6, 1);
        var intensity = QQ_1.QQ.valueOf(7, 1);
        var d = Dimensions_1.Dimensions.valueOf(M, L, T, Q, temperature, amount, intensity);
    ...
    it("Construction(number)", function () {
        var d = Dimensions_1.Dimensions.valueOf(R1, R2, R3, R4, R5, R6, R7);
        expect(d.M.numer).toBe(1);
        expect(d.M.denom).toBe(1);
        expect(d.L.numer).toBe(2);
        expect(d.L.denom).toBe(1);
    ...
    it("mul", function () {
        var M = Dimensions_1.Dimensions.valueOf(R1, R0, R0, R0, R0, R0, R0);
        var L = Dimensions_1.Dimensions.valueOf(R0, R1, R0, R0, R0, R0, R0);
        var T = Dimensions_1.Dimensions.valueOf(R0, R0, R1, R0, R0, R0, R0);
        var Q = Dimensions_1.Dimensions.valueOf(R0, R0, R0, R1, R0, R0, R0);
        var temperature = Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R1, R0, R0);
        var amount = Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R0, R1, R0);
        var intensity = Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R0, R0, R1);
        var N = M.mul(L).mul(T).mul(Q).mul(temperature).mul(amount).mul(intensity);
    ...
    it("div", function () {
        var one = Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R0, R0, R0);
        var M = Dimensions_1.Dimensions.valueOf(R1, R0, R0, R0, R0, R0, R0);
        var L = Dimensions_1.Dimensions.valueOf(R0, R1, R0, R0, R0, R0, R0);
        var T = Dimensions_1.Dimensions.valueOf(R0, R0, R1, R0, R0, R0, R0);
        var Q = Dimensions_1.Dimensions.valueOf(R0, R0, R0, R1, R0, R0, R0);
        ...
        var amount = Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R0, R1, R0);
        var intensity = Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R0, R0, R1);
        var N = one.div(M).div(L).div(T).div(Q).div(temperature).div(amount).div(intensity);
        expect(N.M.numer).toBe(-1);
        expect(N.M.denom).toBe(1);
        expect(N.L.numer).toBe(-1);
        expect(N.L.denom).toBe(1);
    ...
    it("pow", function () {
        var base = Dimensions_1.Dimensions.valueOf(R1, R2, R3, R4, R5, R6, R7);
        var x = base.pow(R2);
        expect(x.M.numer).toBe(2);
    ...
    it("sqrt", function () {
        var quad = Dimensions_1.Dimensions.valueOf(R1, R2, R3, R2, R2, R2, R2);
        var x = quad.sqrt();
    ...
    it("compatible", function () {
        var one = Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R0, R0, R0);
        var all = Dimensions_1.Dimensions.valueOf(R1, R1, R1, R1, R1, R1, R1);
        var mass = Dimensions_1.Dimensions.valueOf(R1, R0, R0, R0, R0, R0, R0);
        var length = Dimensions_1.Dimensions.valueOf(R0, R1, R0, R0, R0, R0, R0);
        var time = Dimensions_1.Dimensions.valueOf(R0, R0, R1, R0, R0, R0, R0);
        var charge = Dimensions_1.Dimensions.valueOf(R0, R0, R0, R1, R0, R0, R0);
        var temperature = Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R1, R0, R0);
        var amount = Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R0, R1, R0);
        var intensity = Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R0, R0, R1);
    ...
    it("isOne()", function () {
        expect(Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R0, R0, R0).isOne()).toBe(true);
        expect(Dimensions_1.Dimensions.valueOf(R1, R0, R0, R0, R0, R0, R0).isOne()).toBe(false);
        expect(Dimensions_1.Dimensions.valueOf(R0, R1, R0, R0, R0, R0, R0).isOne()).toBe(false);
        expect(Dimensions_1.Dimensions.valueOf(R0, R0, R1, R0, R0, R0, R0).isOne()).toBe(false);
        expect(Dimensions_1.Dimensions.valueOf(R0, R0, R0, R1, R0, R0, R0).isOne()).toBe(false);
        expect(Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R1, R0, R0).isOne()).toBe(false);
        expect(Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R0, R1, R0).isOne()).toBe(false);
        return expect(Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R0, R0, R1).isOne()).toBe(false);
    });
    it("inv()", function () {
        var dims = Dimensions_1.Dimensions.valueOf(R1, R2, R3, R4, R5, R6, R7).inv();
    ...
    it("toString()", function () {
        expect("" + Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R0, R0, R0)).toBe("");
        expect("" + Dimensions_1.Dimensions.valueOf(R1, R0, R0, R0, R0, R0, R0)).toBe("mass");
        expect("" + Dimensions_1.Dimensions.valueOf(R2, R0, R0, R0, R0, R0, R0)).toBe("mass ** 2");
        expect("" + (Dimensions_1.Dimensions.valueOf(R0, R1, R0, R0, R0, R0, R0))).toBe("length");
        expect("" + (Dimensions_1.Dimensions.valueOf(R0, R0, R1, R0, R0, R0, R0))).toBe("time");
        expect("" + (Dimensions_1.Dimensions.valueOf(R0, R0, R0, R1, R0, R0, R0))).toBe("charge");
        expect("" + (Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R1, R0, R0))).toBe("thermodynamic temperature");
        expect("" + (Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R0, R1, R0))).toBe("amount of substance");
        expect("" + (Dimensions_1.Dimensions.valueOf(R0, R0, R0, R0, R0, R0, R1))).toBe("luminous intensity");
        return expect("" + (Dimensions_1.Dimensions.valueOf(R0, R1, QQ_1.QQ.valueOf(-2, 1), R0, R0, R0, R0))).toBe("length * time ** -2");
    });
});
