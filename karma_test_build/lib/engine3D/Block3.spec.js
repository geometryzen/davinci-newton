...
describe("Block3", function () {
    describe("updateAngularVelocity", function () {
        it("should accurately update Ω", function () {
            var body = new Block3_1.Block3(Geometric3_1.Geometric3.scalar(2), Geometric3_1.Geometric3.scalar(3), Geometric3_1.Geometric3.scalar(5));
            var w = body.width;
            var h = body.height;
            var d = body.depth;
            var ww = w.a * w.a;
            var hh = h.a * h.a;
            var dd = d.a * d.a;
            body.M = Geometric3_1.Geometric3.scalar(Math.random());
            body.L.yz = 0;
            body.L.zx = 0;
            body.L.xy = 1;
    ...
    describe("moment of inertia tensor", function () {
        ...
        var body = new Block3_1.Block3(Geometric3_1.Geometric3.scalar(Math.random(), METER));
        body.width = Geometric3_1.Geometric3.scalar(4, METER);
        body.height = Geometric3_1.Geometric3.scalar(3, METER);
        body.depth = Geometric3_1.Geometric3.scalar(5, METER);
        body.M = Geometric3_1.Geometric3.scalar(12, KILOGRAM);
