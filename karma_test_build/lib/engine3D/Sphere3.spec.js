...
describe("Sphere3", function () {
    describe("updateAngularVelocity", function () {
        it("dimensionless should accurately update Ω", function () {
            var body = new Sphere3_1.Sphere3(Geometric3_1.Geometric3.scalar(1 - 0.5 * Math.random()));
            body.M = Geometric3_1.Geometric3.scalar(1 + Math.random());
            body.L.yz = Math.random();
            body.L.zx = Math.random();
            body.L.xy = Math.random();
            var r = body.radius;
            var s = 5 / (2 * body.M.a * r.a * r.a);
        ...
        describe("dimensioned should accurately update Ω", function () {
            var body = new Sphere3_1.Sphere3(Geometric3_1.Geometric3.scalar(1 - 0.5 * Math.random(), METER));
            body.M = Geometric3_1.Geometric3.scalar(1 + Math.random(), KILOGRAM);
            body.L = Geometric3_1.Geometric3.bivector(Math.random(), Math.random(), Math.random(), MOTION.mul(METER));
            var r = body.radius;
            var s = 5 / (2 * body.M.a * r.a * r.a);
            body.updateAngularVelocity();
    ...
    describe("moment of inertia tensor", function () {
        ...
        var body = new Sphere3_1.Sphere3(Geometric3_1.Geometric3.scalar(Math.random(), METER));
        body.radius = Geometric3_1.Geometric3.scalar(7, METER);
        body.M = Geometric3_1.Geometric3.scalar(5, KILOGRAM);
