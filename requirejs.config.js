...
requirejs.config({
  ...
  // files to include along with almond.  only newton is defined, as
  // it pulls in the rest of the dependencies automatically.
  include: ["davinci-newton"],
  ...
  wrap: {
    ...
    end:   "  var library = require('davinci-newton').default;\n"+
