...
export class Dimensions {
     ...
     */
    public static readonly ONE = new Dimensions(R0, R0, R0, R0, R0, R0, R0);

    /**
     * M<sup>1</sup>
     */
    public static readonly MASS = new Dimensions(R1, R0, R0, R0, R0, R0, R0);

    /**
     * L<sup>1</sup>
     */
    public static readonly LENGTH = new Dimensions(R0, R1, R0, R0, R0, R0, R0);

    /**
     * T<sup>1</sup>
     */
    public static readonly TIME = new Dimensions(R0, R0, R1, R0, R0, R0, R0);

    /**
     * Q<sup>1</sup>
     */
    public static readonly CHARGE = new Dimensions(R0, R0, R0, R1, R0, R0, R0);

    /**
     * Q<sup>1</sup>T<sup>-1<sup>
     */
    public static readonly CURRENT = new Dimensions(R0, R0, M1, R1, R0, R0, R0);

    /**
     *
     */
    public static readonly TEMPERATURE = new Dimensions(R0, R0, R0, R0, R1, R0, R0);

    /**
     *
     */
    public static readonly AMOUNT = new Dimensions(R0, R0, R0, R0, R0, R1, R0);

    /**
     *
     */
    public static readonly INTENSITY = new Dimensions(R0, R0, R0, R0, R0, R0, R1);
